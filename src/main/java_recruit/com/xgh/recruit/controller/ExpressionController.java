...
@Controller
@Scope("prototype")
@RequestMapping(value = "/recruit/expression/")
public class ExpressionController extends BaseController {
    /**
     * @Fields serialVersionUID :
     */
    private static final long serialVersionUID = 1L;
    private static Logger logger = Logger.getLogger(ExpressionController.class);
    ...
    public ModelAndView add(@ModelAttribute Recommend recommend, @RequestParam String op) {
        ...
        view.setViewName("recruit/expression/add");
    ...
    public ModelAndView init() {
        ModelAndView view = new ModelAndView();
        view.setViewName("recruit/expression/init");
