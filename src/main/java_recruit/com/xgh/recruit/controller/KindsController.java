...
import com.xgh.recruit.service.IKindsService;
...
@Controller
@Scope("prototype")
@RequestMapping(value = "/recruit/kinds/")
public class KindsController extends BaseController {
    ...
    public ModelAndView init() {
        ...
        view.setViewName("recruit/kinds/init");
    ...
    public ModelAndView add(@ModelAttribute Kinds kinds, @RequestParam String op) {
        ...
        view.setViewName("recruit/kinds/add");
    ...
    public void level(@ModelAttribute Kinds kinds) {
        ...
        if (kinds2 != null && kinds2.getLevel() < 3) {
    ...
    public void getChildTreeData(long kindsId) {
