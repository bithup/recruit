...
@Controller
@Scope("prototype")
@RequestMapping(value = "/recruit/goodsIdea/")
public class GoodsIdeaController extends BaseController {
    /**
     * @Fields serialVersionUID :
     */
    private static final long serialVersionUID = 1L;
    private static Logger logger = Logger.getLogger(GoodsIdeaController.class);
    ...
    public ModelAndView add(@ModelAttribute Recommend recommend, @RequestParam String op) {
        ...
        view.setViewName("recruit/goodsIdea/init");
