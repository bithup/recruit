...
public class EntityUtil {
    ...
    private final String moduleName = "recruitment"; // ��Ӧģ�����ƣ������Լ�ģ������Ӧ����!!!����޸�^_^��
    ...
    private final String beanFullName = "com.xgh.recruit.entity.";
    ...
    private List<String> getTables() throws SQLException {
        ...
        PreparedStatement pstate = conn.prepareStatement("show tables like 'tb_position' ");
