...
<head>
    ...
    <script type="text/javascript">
        ...
        function getList(){
            ...
            var url_1 = "/recruit/company/getListPage.htm?isCheck=0&account="+account;
            $("#listgrid").ligerGrid({
                columns: [${gridComluns}],
                url: url_1,
                parms: [
        ...
        function h2y_check(){
            ...
            var src = "/recruit/check/companyCheck.htm?id=" + rows[0].id;
            top.f_addTab("_recruit_check_companyCheck_htm_id_" + rows[0].id, "企业审核详情", src);
        }
