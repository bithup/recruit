...
<head>
    ...
    <script type="text/javascript">
        ...
        function h2y_save() {
            ...
            $.post("recruit/findillness/save.htm", queryString, function (data) {
                var jsonReturn = eval("(" + data + ")");
                if (op == "modify") {
                    if (jsonReturn.code == "1") {
                        alert(jsonReturn.msg);
                        if (top.f_getframe("recruit_findillness_init_htm") != null) {
                            top.f_getframe("recruit_findillness_init_htm").f_query();
                            top.f_delTab("recruit_findillness_add_htm_op_modify_id_${recommend.id}");
                        }
                    } else {
                        alert(jsonReturn.msg);
                    }
                    ...
                    if (jsonReturn.code == "1") {
                        ...
                        if (top.f_getframe("recruit_findillness_init_htm") != null) {
                            top.f_getframe("recruit_findillness_init_htm").f_query();
                            top.f_delTab("recruit_findillness_add_htm_op_add_id");
                        }
                    } else {
                        alert(jsonReturn.msg);
                    }
