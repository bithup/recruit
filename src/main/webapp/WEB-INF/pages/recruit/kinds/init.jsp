...
<head>
    ...
    <script type="text/javascript">
        ...
        function f_getList() {
            var url_1 = "recruit/kinds/getList.htm";
            //显示的是名称，编码等列
            $("#listgrid").ligerGrid({
                columns: [${gridComluns}],
                url: url_1,
                parms: [
                    {name: "pid", value: id}, {name: "op", value: "grid"},{name:"level",value:Kindlevel}
                ],
                showTitle: false,
                dataAction: "server",
                sortName: "id",
        ...
        function f_onSelect(node) {
            ...
            if (level!=4 && !hasChild) {
                $.ajax({
                    type: "POST",
                    url: "recruit/kinds/getChildTreeData.htm?op=tree",
                    data: {kindsId: id},
        ...
        function h2y_add() {
            ...
            $.ajax({
                type: "POST",
                url: "recruit/kinds/getLevel.htm",
                data: {id: id},
        ...
        function h2y_add2(){
            var src = "<%=basePath%>recruit/kinds/add.htm?op=add&parentId=" + id;
            $.ligerDialog.open({
                name: "sys_kind_add",
                title: "添加分类",
                height: 340,
        ...
        function h2y_modify() {
            ...
            var src = "<%=basePath%>recruit/kinds/add.htm?op=modify&id=" + rows[0].id;
            $.ligerDialog.open({
        ...
        function h2y_delete() {
            ...
            $.post("recruit/kinds/delete.htm?id=" + rows[0].id, function (data) {
